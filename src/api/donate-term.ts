...
import { NewsletterRequestResultModel } from "../services/newsletterRequestModel"
import { DonateTermRequestModel } from "../services/donationTermRequestModel"
...
function createEmail(input: DonateTermRequestModel): MailOptionsModel {
  return {
...
export default function donateTerm(
