  ...
  return (
    <div className="relative h-full sm-h-screen w-screen">
      ...
      <div className="relative w-full min-h-screen sm:h-screen pt-20 z-10 flex flex-wrap">
        <div className="w-full sm:w-1/2 p-8 flex justify-center items-center h-full">
          <div className="bg-gray-50 shadow-md p-8 rounded-xl w-full sm:w-2/3">
            <h1>{title}</h1>
            <p>{subtitle}</p>
            <p>{description}</p>
            <button
        ...
        <div className="w-full h-full sm:w-1/2 flex justify-center items-center p-8">
          <StatsInformation />
        </div>
      </div>
    </div>
