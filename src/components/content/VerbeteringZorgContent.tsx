...
const VerbeteringZorgContent: React.FC = () => {
  return (
    <div className="col-span-4 sm:col-span-2">
      ...
      <p>
        Missie Tumor Onbekend werkt samen met zorgverleners hard aan het
        ...
        richtlijn, en steunt projecten die de implementatie hiervan vergroten.
      </p>

      <p>
        <strong>
          Missie Tumor Onbekend wil onder andere de volgende projecten
          realiseren in het kader van het verbeteren van de inzet van zorg voor
          PTO-patiënten.
        </strong>
      </p>
      ...
      <ul>
        ...
        <li>
          Doorontwikkeling en beschikbaar maken van een app die PTO-patiënten
          kan ondersteunen
        </li>
      </ul>
...
export default VerbeteringZorgContent
